...
class TsEmgOptions(Structure):
    """
    EMG options structure. provides information about filter parameters.
    Attributes:
...
class TsEmgChannelData(Structure):
    """
    EMG channel data structure. provides information about channel index, number of samples and samples.
    Attributes:
...
class TsEmgNodeData(Structure):
    """
    EMG node data structure. provides information about node index, number of channels, channels data and timestamps.
    Attributes:
...
class TsEmgData(Structure):
    """
    EMG data structure. provides information about number of nodes, Pointer to nodes data and options.
    Attributes:
...
class TsEmg:
    """
    EMG sensors streaming class.
    This class is used to stream EMG data from the device.
    It provides methods to start and stop streaming, set options,
    and retrieve the EMG data.
    Attributes:
        __lib: Reference to the Teslasuit SDK library.
        __device: Handle to the Teslasuit device.
        __is_data_ready: Indicates if EMG data is ready to be retrieved.
        __is_started: Indicates if EMG streaming has started.
        __data_callback: Callback function for EMG data updates.
        __data: TsEmgData data object containing information about the nodes, channels, and timestamps.
    """
    ...
    def set_options(self, lower_bandwidth, upper_bandwidth,
        ...
        """
        Sets options for EMG streaming e.g. filter parameters.
        Args:
            lower_bandwidth (int): filter's lower bandwidth.
            upper_bandwidth (int): filter's upper bandwidth.
    ...
    def start_streaming(self):
        """ 
        Starts EMG sensors streaming.
        Subscribes to data update callbacks and begins the streaming process.
        """
    ...
    def stop_streaming(self):
        """
        Stops EMG sensors streaming.
        Unsubscribes from data update callbacks and halts the streaming process.
        """
    ...
    def get_data(self):
        """
        Retrieves the EMG data.
        Return:
            TsEmgData: The EMG data object containing information about the nodes, channels, and timestamps.
        """
        self.__is_data_ready = False
        return self.__data
    ...
    def get_data_on_ready(self):
        """
        Blocks execution until EMG data is ready and returns the latest EMG data.
