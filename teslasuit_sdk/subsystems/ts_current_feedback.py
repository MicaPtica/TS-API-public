...
class TsCurrentFeedback:
    """
    Class for handling current feedback data streaming."""
    ...
    def get_data_on_ready(self):
        """
        Waits for the current feedback data to be ready and returns it.
        This method blocks until the data is ready.
        Returns: 
            A TsCurrentFeedbackNodes object containing the current feedback data.
        """
