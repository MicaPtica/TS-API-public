...
class TsDeviceManager:
    """
    Handles the connection and disconnection of TESLASUIT devices.
    Provides access to connected devices and their properties."""
    ...
    def wait_for_device_to_connect(self, number_of_devices_to_wait=1):
        ...
        Args:
            number_of_devices_to_wait (int): Number of devices to wait for.
        """
    ...
    def get_or_wait_last_device_attached(self):
        """
        Either returns the last device connected or waits for a device to connect.
        Returns:
