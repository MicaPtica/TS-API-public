...
```python
    def haptic_play_touch(
            ...
            channel_id,
            ampl=100,
            period=20000,   # period in µs; 20000 µs = 50 Hz (1000000 / frequency_hz)
            pw=100,
            duration=100):  # touch duration in milliseconds
...
- `period`: period of the waveform **in microseconds (µs)**; use `1000000 / frequency_hz` to convert (e.g. 20,000 µs = 50 Hz)
- `pw`: pulse width
